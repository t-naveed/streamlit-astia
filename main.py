...
def send_message():
    ...
    for i in range(len(number_column)):
        ...
        message = client.messages.create(
            body="It is flu season, get your flu shot. If you are eligible for an updated COVID 19 booster, "
                 "you can get your flu shot at the same time. Visit covid19.nj.gov/finder to find a convenient "
    ...
    with tab1:
        ...
        with left_column:
            ...
            if options == 'Flu Season (Recommended)':
                ...
                with left_column:
                    if st.button("Confirm Template", key=None, help=None, on_click=None):
                        st.success("Template Selected. Go to Target tab")
                    ...
                    with left_column:
                        ...
                        if st.button("Launch Attack", key=None, help=None, on_click=None):
                            try:
                                ...
                                st.error("An exception occurred for this number")
                except:
